			...
			float3 ClipToWorldPos(float4 clipPos)
{
			...
			Varyings LitPassVertex(Attributes IN) {
				...
				OUT.positionCS = float4((round(positionInputs.positionCS.xy / positionInputs.positionCS.w * float2(320, 480))/float2(320, 480) * positionInputs.positionCS.w), positionInputs.positionCS.z, positionInputs.positionCS.w);
